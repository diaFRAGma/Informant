...
-- "EK Preis:VK Preis:Klasse1:?:Stack:Klasse2:Benutzt für:?:?
-- Klasse 1
--  0 Verbrauchbar
--  1 Behälter
--  2 Waffe
...
-- Firework = Feuerwerk
-- Food	= Nahrung
-- Giftwrap = Geschenkpapier
-- Lure = Köder
-- Poison = Gift
-- Potion = Trank
-- Restorative = Stärkungstrank
-- Scroll = Zauberspruchrolle
-- Alchemy = Alchemie
...
-- Mage = Magierzauber
-- Mining = Bergbau
-- Paladin = Paladinzauber
-- Priest = Priesterzauber
-- Rogue = Schurkenfertigkeit
-- Shaman = Schamanenzauber
...
Informant.SetDatabase({
	[22393]=":14750:3::1::::", -- Kodex: Gebet des Schattenschutzes
	[21312]=":6377:4::1::::", -- Gürtel des Höhlenbehüters
	[21311]=":8473:4::1::::", -- Weste des Erdenwächters
	[24102]=":100000:3::1::::", -- Handbuch des Ausweidens IX
	[23199]=":18858:4::1::-7::", -- Totem des Sturms
	[20769]=":2500:3::1::::", -- Ekelhafter Schlammling
	[20015]=":1658:3::10::::", -- Federn eines alten Raptors
	[20770]=":450:3::10::::", -- Blubberndes grünes Sekret
	[20763]=":312:3::5::::", -- Beschädigte Waffe
	[22311]=":14944:4::1::::", -- Eisengewebte Stiefel
	[24222]=":44210:2::1::::", -- Dolch des schleichenden Todes
	[19933]=":2080:3::10::::", -- Leuchtendes Skorpidblut
	[19934]=":1400:3::10::::", -- Große Skorpidklaue
	[20424]=":175:7::20::185::", -- Sandwurmfleisch
	[20408]=":1942:4::1::::", -- Gugel eines Schattenhammerkultisten
	[20406]=":1929:4::1::::", -- Mantel eines Schattenhammerkultisten
	[20407]=":2581:4::1::::", -- Robe eines Schattenhammerkultisten
	...
	[18945]="0:100:12:0:100:::0:0:", -- Dark Iron Residue
